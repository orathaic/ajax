...
function MenuOutput()
{
 foreach($this->Menu as $i => $MenuItem) {echo "<input type='button' value='$MenuItem' name='tab=$MenuItem&parentid=PageContainer'>";} // Button($MenuItem); 
}
...
{ //$this->Head();
	...
	$ToReturn .= 	'<b>Login:</b><br /><input type="text" name="user" size="15">
...
class ColonyWars extends Game 
{
	...
	?> 
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en"><head><title><? echo $title; ?></title>
...
//	<script type="text/javascript" src="js/clay_func.js"></script>
?>
